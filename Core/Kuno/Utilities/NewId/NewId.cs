...
using Kuno.Utilities.NewId.NewIdFormatters;
using Kuno.Utilities.NewId.NewIdProviders;
...
#pragma warning restore CS0675 // Bitwise-or operator used on a sign-extended operand
        ...
        public int CompareTo(object obj)
        {
            ...
            return this.CompareTo((NewId)obj);
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            byte[] bytes = sequential ? this.GetSequentialFormatteryArray() : this.GetFormatteryArray();
